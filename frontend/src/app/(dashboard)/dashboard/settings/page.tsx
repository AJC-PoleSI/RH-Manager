  ...
  return (
    <div className="max-w-[960px] mx-auto py-8 px-4">
      ...
      <div className="bg-white border border-gray-200 rounded-[10px] p-[18px_20px] mb-[14px]">
        ...
        {/* ---- Réservation des créneaux : exception « dernière minute ---- */}
        <div className="mt-5 pt-4 border-t border-gray-200">
          <label className="block text-sm font-medium text-gray-700 mb-1">
            Réservation de dernière minute — jusqu&apos;au
          </label>
          <input
            type="date"
            value={lastMinuteUntil}
            onChange={(e) => setLastMinuteUntil(e.target.value)}
            className="w-full sm:w-1/2 border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          <p className="mt-2 text-xs text-gray-500 leading-relaxed">
            Par défaut, un candidat ne peut plus réserver un créneau qui
            commence dans moins de 24h. Les créneaux jusqu&apos;à cette date{" "}
            <strong>incluse</strong> font exception : réservables jusqu&apos;à
            leur début. Les jours suivants gardent leurs 24h — le réglage
            s&apos;arrête donc tout seul, rien à remettre à zéro. Laisser vide
            pour appliquer les 24h partout.
          </p>
        </div>
