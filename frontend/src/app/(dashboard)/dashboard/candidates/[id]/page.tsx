    ...
    return (
      <div className="text-center py-16">
        ...
        <p className="text-sm text-gray-500 mb-4">
          Vous n&apos;avez pas la permission de consulter cette fiche.
        </p>
        <button
          onClick={() => router.back()}
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        {!isCandidate && candidate.comments && (
          <div className="mt-4 p-3 bg-yellow-50 rounded-lg text-sm border border-yellow-100">
            <span className="font-medium text-yellow-700">Note interne : </span>
            {candidate.comments}
          </div>
        )}
