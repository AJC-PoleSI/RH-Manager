    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 space-y-6 text-sm text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">2. Donnees collectees</h2>
            <p>Dans le cadre du processus de recrutement, nous collectons les donnees suivantes :</p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">3. Finalite du traitement</h2>
            <p>Les donnees collectees sont utilisees exclusivement pour :</p>
            <ul className="mt-2 space-y-1 list-disc list-inside text-gray-600">
              <li>La gestion du processus de recrutement (candidatures, evaluations, deliberations)</li>
              <li>L&apos;organisation logistique des epreuves (planning, salles, jurys)</li>
              <li>La communication avec les candidats et les membres evaluateurs</li>
              <li>L&apos;etablissement de statistiques anonymisees sur le recrutement</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">5. Duree de conservation</h2>
            <p>
              Les donnees des candidats sont conservees pendant la duree du processus de recrutement
              et jusqu&apos;a 12 mois apres la fin de celui-ci. Les donnees des membres evaluateurs
              sont conservees pendant la duree de leur mandat.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">7. Securite des donnees</h2>
            <p>
              Nous mettons en oeuvre des mesures techniques et organisationnelles appropriees
              pour proteger vos donnees : chiffrement des mots de passe, acces restreint par
              authentification, hebergement securise, protocole HTTPS.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">8. Vos droits</h2>
          ...
          <section>
            ...
            <p>
              Cette application utilise uniquement des cookies techniques necessaires a son
              fonctionnement (jeton d&apos;authentification JWT). Aucun cookie de suivi,
              d&apos;analyse ou publicitaire n&apos;est utilise.
            </p>
          </section>
