                                ...
                                {c.wishes?.length > 0 && (
                                    <div className="flex items-center gap-2 mt-2 flex-wrap">
                                        ...
                                        {c.wishes.map((w: any, i: number) => (
                                            <span key={`reserve-${i}`} className="text-[10px] px-1.5 py-0.5 bg-amber-100 text-amber-700 rounded-full font-medium">
                                                #{w.rank} {w.pole}
                                            </span>
                                        ))}
                                    </div>
                                    ...
                                    {evals.length === 0 ? (
                                        ...
                                        <div className="space-y-2">
                                            {evals.map((e: any, i: number) => (
                                                <div key={`reserve-${i}`} className="bg-gray-50 rounded p-2 text-xs border">
