...
const Sidebar = () => {
  ...
  const adminSections: NavSection[] = [
    ...
    {
      title: "Communication",
      items: [{ href: "/dashboard/messages", label: "Messagerie", icon: "✉️" }],
    },
  ];
  ...
  const memberSections: NavSection[] = [
    ...
    {
      title: "Communication",
      items: [{ href: "/dashboard/messages", label: "Messages", icon: "✉️" }],
    },
  ];
  ...
  const candidateSections: NavSection[] = [
    ...
    {
      title: "Communication",
      items: [{ href: "/candidates/messages", label: "Messages", icon: "✉️" }],
    },
  ];
            ...
            <div key={section.title} className={idx > 0 ? "mt-5" : ""}>
              ...
              <p
                className={cn(
                  ...
                  isExpanded
                    ? "opacity-100 mb-2 h-auto max-md:opacity-100 max-md:mb-2"
                    : "md:opacity-0 md:h-0 md:mb-0",
